...
Personal mobile-first PWA for meal and bowel tracking. Firebase backend, React frontend, Cloud Run AI tagging.
...
scripts/
  seed.mjs                      # seeds local Firestore with meals + pre-filled analysis objects
services/
